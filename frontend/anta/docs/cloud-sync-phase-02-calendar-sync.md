...
**Status: planned.** Migration **v26**. Depends on Phase 01. Symbol names
below are targets from the migration plan — re-verify each against the code
...
`test/database/` schema-parity for v26 (create-vs-migrate).

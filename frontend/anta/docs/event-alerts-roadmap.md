...
`showTimePicker` — `TimePadSheet` since 2026-09-24), Sound (alarm only — see below), and the remove switch
...
dart`): big time (tap → `TimePadSheet`, `showTimePicker` before 2026-09-24; default next quarter hour), three

...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get filterPresetSaveCurrent => 'Save the current filter';
  ...
  String deleteFolderWithNotesConfirm(String name, int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'This will also delete $count notes.',
      one: 'This will also delete 1 note.',
    );
  ...
  String noteStats(int count, int chunks) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count distinct characters',
      one: '1 distinct character',
    );
  ...
  String importedSummary(int folders, int notes) {
    String _temp0 = intl.Intl.pluralLogic(
      folders,
      locale: localeName,
      other: 'Imported $folders folders',
      one: 'Imported 1 folder',
    );
    String _temp1 = intl.Intl.pluralLogic(
      notes,
      locale: localeName,
  ...
  @override
  String get eventAlertAtStart => 'At start';
  ...
  String eventAlertAllDayOnDay(String time) {
    return 'On the day, $time';
  }

  @override
  String eventAlertAllDayDayBefore(String time) {
    return 'The day before, $time';
  }
  ...
  String eventAlertAllDayDaysBefore(int count, String time) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count days before, $time',
      one: '1 day before, $time',
    );
    return '$_temp0';
  }
  ...
  @override
  String get quickAlarmTitle => 'Quick alarm';

  @override
  String get quickAlarmName => 'Alarm';

  @override
  String get quickAlarmPickTime => 'Change time';

  @override
  String get quickAlarmIn20Min => 'In 20 min';

  @override
  String get quickAlarmIn1Hour => 'In 1 hour';
  ...
  String deleteSelectedConfirm(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Delete $count selected items? This cannot be undone.',
      one: 'Delete 1 selected item? This cannot be undone.',
    );
    return '$_temp0';
  }
  ...
  @override
  String get timePadDone => 'Done';

  @override
  String get timePadOnTheHour => 'On the hour';

  @override
  String get timePadHalfPast => 'Half past';

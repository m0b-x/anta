...
class AlarmService : Service() {
    companion object {
        ...
        /**
         * Action carried by the show intent of an alarm-clock entry (ANTA
         * fork, Patch 1).
         *
         * `AlarmScheduler` arms every exact alarm with
         * `AlarmManager.setAlarmClock`, whose show intent is what the lock
         * screen's alarm line and Quick Settings launch. That intent is the
         * application's launch intent with this action and the alarm id under
         * [EXTRA_ALARM_ID], so the launcher activity can tell a tap on the
         * phone's "next alarm" from an ordinary launch.
         */
        const val ACTION_SHOW = "com.gdelataillade.alarm.action.SHOW"
